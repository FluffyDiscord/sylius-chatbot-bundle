...
readonly class BitBagCmsPagesDataSource implements ChatbotDataSourceInterface
{
    ...
    public function getDefinition(): SourceDefinition
    {
        return new SourceDefinition(
            'bitbag_cms_pages',
            'fluffydiscord_sylius_chatbot.source.bitbag_cms_pages.description',
        );
    }
    ...
    private function getPageRouteName(): string
    {
    ...
    private function resolveTitle(PageTranslationInterface $translation): ?string
    {
