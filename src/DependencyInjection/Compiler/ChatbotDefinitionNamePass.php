...
namespace FluffyDiscord\SyliusChatbotBundle\DependencyInjection\Compiler;
...
class ChatbotDefinitionNamePass implements CompilerPassInterface
{
    ...
    {
        $this->indexTaggedServices($container, 'fluffydiscord_chatbot.tool');
        $this->indexTaggedServices($container, 'fluffydiscord_chatbot.source');
    }

    private function indexTaggedServices(ContainerBuilder $container, string $tag): void
    {
        $serviceIdsByName = [];
